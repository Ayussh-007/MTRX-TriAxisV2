  ...
  if (loading) return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '60vh' }}>
      <div style={{ textAlign: 'center' }}>
        <div style={{ fontSize: '2.5rem', marginBottom: '0.8rem', animation: 'pulse 1.5s infinite', display: 'flex', justifyContent: 'center', color: 'var(--text-muted)' }}>
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        {[
          { label: 'Students', value: metrics.num_students, icon: 'users', color: '#6366F1', suffix: '' },
          { label: 'Avg Score', value: metrics.avg_score, icon: 'trend', color: '#34D399', suffix: '%' },
          { label: 'Attendance', value: metrics.avg_attendance, icon: 'cal', color: '#60A5FA', suffix: '%' },
          { label: 'Quizzes Taken', value: metrics.total_quizzes, icon: 'quiz', color: '#FB923C', suffix: '' },
        ].map((m, i) => (
          <div key={i} style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.82rem', fontWeight: 700, color: 'var(--text)', marginBottom: '0.5rem', alignSelf: 'flex-start', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
      ...
      <div style={{
        ...
        {[
          { label: 'Take Attendance', icon: 'att', to: 'attendance', color: '#22C55E' },
          { label: 'Create Quiz', icon: 'quiz', to: 'quiz', color: '#6366F1' },
          { label: 'Upload Curriculum', icon: 'doc', to: 'curriculum', color: '#60A5FA' },
          { label: 'Make Slides', icon: 'slides', to: 'slides', color: '#A78BFA' },
        ].map((a, i) => (
          <button
            key={i}
          ...
          >
            <span style={{ fontSize: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={a.color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                {a.icon === 'att' && <><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></>}
                {a.icon === 'quiz' && <><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></>}
                {a.icon === 'doc' && <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></>}
                {a.icon === 'slides' && <><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></>}
              </svg>
            </span>
